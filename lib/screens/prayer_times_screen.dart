...
class _PrayerTimesScreenState extends State<PrayerTimesScreen> {
  ...
  // Load 24-hour format setting from SharedPreferences
  Future<void> _load24HourFormatSetting() async {
  ...
  void _calculateTimeUntilNextPrayer() {
    ...
    String nextPrayerName = 'Fajr (next day)';
          ...
          IconButton(
            ...
            onPressed: () async {
              ...
              setState(() {
                ...
                prefs.setBool('24_hour_format', is24HourFormat);
              });
            },
            tooltip: is24HourFormat ? 'Switch to 12-hour format' : 'Switch to 24-hour format',
          ),
        ],
      ),
      body: Column(
        children: [
          ...
          Expanded(
            child: SingleChildScrollView(
              child: Column(
                children: [
                  _buildPrayerTimeRow("Fajr", times['fajr']['adhan'], times['fajr']['iqama']),
                  _buildSunriseBox(times['sunrise']),
                  _buildPrayerTimeRow("Dhuhr", times['dhuhr']['adhan'], times['dhuhr']['iqama']),
                  _buildPrayerTimeRow("Asr", times['asr']['adhan'], times['asr']['iqama']),
                  _buildPrayerTimeRow("Maghrib", times['maghrib']['adhan'], times['maghrib']['iqama']),
                  _buildPrayerTimeRow("Isha", times['isha']['adhan'], times['isha']['iqama']),
                  _buildJummaBox(),
                  const SizedBox(height: 8),
                ],
              ),
